...
export class EmployeeDatasourceImpl implements EmployeeDatasource {
  ...
  public async getById(getByIdDto: GetEmployeeByIdDto): Promise<EmployeeEntity> {
    ...
    return EmployeeEntity.fromJson(employee);
  }
  ...
  public async create(createDto: CreateEmployeeDto): Promise<EmployeeEntity> {
    ...
    if (person?.employee?.id && person.employee.archived) {
      ...
      return EmployeeEntity.fromJson(restoredEmployee);
    }
    ...
    if (!email) {
      ...
      return EmployeeEntity.fromJson(createdEmployee);
    }
  ...
  public async update(updateDto: UpdateEmployeeDto): Promise<EmployeeEntity> {
    ...
    return EmployeeEntity.fromJson(updatedEmployee);
  }

  public async delete(getByIdDto: GetEmployeeByIdDto): Promise<EmployeeEntity> {
    ...
    return EmployeeEntity.fromJson(deletedEmployee);
  }
}
